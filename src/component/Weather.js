...
import { View, Text, TextInput, Button, Image, ActivityIndicator, Switch, FlatList, ScrollView, ImageBackground, TouchableOpacity } from 'react-native';
import { createApi, fetchBaseQuery } from '@reduxjs/toolkit/query/react';
import { styles } from '../styles/styles';
import { StatusBar } from 'expo-status-bar';
import { CalendarDaysIcon, MagnifyingGlassIcon, XCircleIcon } from "react-native-heroicons/outline"; // Import XIcon
            ...
            <ImageBackground blurRadius={40} style={styles.backgroundImage} source={require("../../assets/10.png")} className='Absolute w-full h-full'>
                <View style={styles.card}>
                    <View style={styles.serachbar}>
                        ...
                        />
                        <TouchableOpacity style={styles.iconsearch1} onPress={handleClear}>
                    ...
                    {weatherError && <Text style={styles.errorText}>Error: {weatherError.message}</Text>}
